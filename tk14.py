...
root.rowconfigure(1, weight=1)  # main body
root.rowconfigure(2, weight=1)  # earnings/deductions
...
for i, text in enumerate(labels_left):
    ...
    entry.grid(row=i, column=1, sticky="ew", pady=4, padx=(40, 10))
...
tk.Label(earn_frame, text="Amount", font=("Arial", 9, "bold"), bg="#f2f2f2").grid(row=0, column=5)
