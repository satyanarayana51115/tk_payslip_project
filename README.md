...
```mermaid
graph TD
    A[User Desktop GUI Form] --> B[Input Data: Employee & Salary Details]
    B --> C[Payroll Calculation Engine]
    C --> D[Gross Pay & Deductions Processing]
    D --> E[Net Salary Output]
    E --> F[Structured Payslip Preview / Display]
```
